...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/IP-SHOWER/blob/main/20250730_194505.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/IP-SHOWER
    $ cd IP-SHOWER
    $ python Mithila.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/IP-SHOWER && cd IP-SHOWER && python Mithila.py
 ### Hi there 👋
